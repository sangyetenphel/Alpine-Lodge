			...
			<div class="contact">
				<h3>Personal Details</h3>
					<form action="act-register.php" method="POST">
						...
						<input type="text" name="email" id="email" value="<?php echo $email?>"required placeholder="Your Email" pattern="[a-zA-Z]{3,}@[a-zA=Z]{3,}[.]{1}[a-zA-Z]{2,}" title="Please enter in a valid email address"><br>
						</p>
						<br>
						<p>
						<label for="name">Username</label>
						<input type="text" name="username" id="name" required autofocus placeholder="Your username" pattern="[a-zA-Z]{3,}" title="Please enter in more than three letters and no spaces"> <br>
						</p>
						<br>
						<p>
